 ...
 * @description：仿真时间窗口
 */
public class SimulateTimeWindowProcessAndFreeTimeRound {
...
//            resourceAgent.setProcessSet(set);
    ...
    public static int[] getRelativeValue(int finishTime) {
        ...
        for (int round=0; round<10; round++) {
            ...
            SimulateTimeWindowProcessAndFreeTimeRound simulateTimeWindow = new SimulateTimeWindowProcessAndFreeTimeRound();
            ...
            for (int i = 0; i < 1000; i++) {
                ...
                int [] endTimes = algoEndTime(subTaskList, totalTime, haveUsedTime, treeMap, finishTime);
...
//        System.out.println(allocatedList.size()+ "  ");
    ...
    private static int[] algoEndTime(List<Integer> subTaskList, int totalTime, int haveUsedTime, TreeMap<Integer, Integer> treeMap, int finishTime) {
        int total = 0;
        int curTotal = 0;
