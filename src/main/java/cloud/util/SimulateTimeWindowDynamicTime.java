 ...
 * @description：仿真时间窗口
 */
public class SimulateTimeWindowDynamicTime {
...
//            resourceAgent.setHaveAssignedTimeSet(new HashSet<>());
    ...
    public static void main(String[] args) {
        ...
        for (int round=0; round<10; round++) {
            ...
            SimulateTimeWindowDynamicTime simulateTimeWindow = new SimulateTimeWindowDynamicTime();
            ...
            for (int i = 0; i < 1000; i++) {
                ...
                for (int k=0; k<20; k++) {
                    ...
                    if (!resourceAgent.getProcessTimeMap().containsKey(firstProcessNo)) {
                        ...
                        int[] relationValueMore = getFirstCurRelationValue(resourceAgent, firstProcessNo,0,endTime);
...
//                        System.out.print(k+ " ");
                        ...
                        if (!resourceAgent.getProcessTimeMap().containsKey(processNo)) {
                            ...
                            for (int p = 0; p < 20; p++) {
                                ...
                                if (preTimeAndValue.tag == false) {
                                    ...
                                    for (int[] preRelationValue : preRelationValues) {
                                        // 取得当前的relativeValue值
                                        int[] curRelationValueMore = getCurRelationValue(preRelationValue, resourceAgent, processNo, preRelationValue[0], endTime);
                            ...
                            Collections.sort(relationValueList, (a,b)->{return a[2]-b[2];});
...
//                    totalCost += curCost;
            ...
            System.out.println(allocated + " " + unallcated +  " " + finishAllocated + " " + totalCost + " " + totalCost/(allocated) + " " + totalProcessTime + " "
                                + totalProcessTime/allocated);
//                    +
