 ...
 * @description：处理输出数据
 */
public class HandleTransOutputDataLitter {
    ...
    public int handleOutputData(int taskNum, int ratio, int rapid, int taskSize, int resourceSize) {
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw
            ...
            /* 读入TXT文件 */
            String pathname = "D:\\Coding\\JavaProject\\multi-agent-trans-v1\\data\\trans-litter\\output" + resourceSize + "-" + (taskSize * taskNum) + "-" + ratio + "-" + rapid + ".txt"; // 绝对路径或相对路径都可以，这里是绝对路径，写入文件时演示相对路径
...
//        System.out.println(maxNum);
    ...
    public static void main(String[] args) {
        HandleTransOutputDataLitter handleOutputData = new HandleTransOutputDataLitter();
