...
import cloud.util.small.SmallDataSimulation;
 ...
 * @description：仿真时间窗口
 */
public class SimulateTimeWindowDynamicTimeMiddle {

    static int resourceSize = 20;
    static int taskSize = 10;
    static int processSum = 8;
    ...
    public static int[] simulateValue(int finishTime) {
        ...
        for (int round = 0; round < 1; round++) {
            ...
            for (int i = 0; i < taskAgents.size(); i++) {
                ...
                TimeAndEValue[][] timeAndEValues = new TimeAndEValue[10][200];
...
//                subTaskList.add();
            ...
            System.out.println("showDataListSize " + showDataList.size());
...
//                    + totalConnectTime + " " + totalConnectTime/totalProcess + " ");
        ...
        System.out.println("eValue is " + (totalSubTaskReward-totalTransferCost-totalProcessCost));
        int[] res = new int[5];
    ...
    public static void main(String[] args) {
        ...
        for (int i=1; i<=1; i++) {
            res.add(simulateValue(SmallDataSimulation.baseEndTime*80));
        }
