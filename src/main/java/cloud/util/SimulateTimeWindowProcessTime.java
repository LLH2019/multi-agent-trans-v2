 ...
 * @description：仿真时间窗口
 */
public class SimulateTimeWindowProcessTime {
...
//            resourceAgent.setHaveAssignedTimeSet(new HashSet<>());
    ...
    public static void main(String[] args) {
        ...
        for (int round=0; round<100; round++) {
            ...
            SimulateTimeWindowProcessTime simulateTimeWindow = new SimulateTimeWindowProcessTime();
            ...
            for (int i = 0; i < 500; i++) {
                ...
                int [] endTimes = algoEndTime(subTaskList);
...
//        System.out.println(" unallcated num ");
    ...
    private static int[] algoEndTime(List<Integer> subTaskList) {
        int total = 0;
        int curTotal = 0;
        int all = endTime;
        ...
        for (int i=0; i<subTaskList.size(); i++) {
            ...
            result[i] = (int) ((double) curTotal/(double)total * all);
        }
        return result;
    }
